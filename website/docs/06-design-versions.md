...
| 1.2.0 | `design-v1.2.0` | 2026-09-10 | 合併醫學圖解與 3D 素材庫（52 篇圖卡、47 組 GLB、圖庫頁），新增 `MEDICAL_VISUALS` 顯示開關；3D 封面作為 GPT 生成圖之後的備援 |
| 1.3.0 | `design-v1.3.0` | 2026-09-10 | 64 張 AI 生成編輯插畫上線：52 篇文章封面、3 張治療主圖、3 張分類橫幅、6 張裝飾背景（BMA 主圖暫存 `_hold/`） |
