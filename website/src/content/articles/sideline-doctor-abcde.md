---
title: 我也想當場邊醫師，第一步該準備什麼？賽場外傷評估的基礎
description: 擔任 2023 世界棒球經典賽場邊醫師後，程皓醫師整理場邊傷害判定的基礎：先確認生命徵象與緊急程度（ABCDE），再評估四肢受傷、神經血管功能，以及何時需要影像檢查。
...
sources:
  - platform: Blog
    date: 2023-04-20
    url: https://drchenghao.blogspot.com/2023/04/blog-post.html
    note: 「我也想當場邊醫師，我第一步該準備什麼?」
  - platform: Facebook
    date: 2023-04-22
    note: 「球員胸口撞擊：如何識別和處理傷勢」
---
...
- 可在現場進行**一次**受損肢體的復位（one on-the-field attempt），是合理且值得鼓勵的。
...
- 依胸腔解剖，優先排除**氣胸、血胸、心包膜填塞**：安排胸部 X 光、心電圖、外傷超音波（E-FAST）；懷疑動脈撕裂則考慮電腦斷層。
...
<div class="note">參考資料：Extremity trauma: field management of sports injuries（2014）；Management of adults with blunt chest trauma in the emergency department（UpToDate）；Evaluation and Treatment of Musculoskeletal Chest Pain（2013）；Thoracic Region Pain in Athletes（2004）。</div>
